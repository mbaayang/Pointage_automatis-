...
PresenceEmployesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([employe_entity_1.Employes, presence_employe_entity_1.PresenceEmploye, presence_etudiant_entity_1.PresenceEtudiant, etudiant_entity_1.Etudiant]),],
