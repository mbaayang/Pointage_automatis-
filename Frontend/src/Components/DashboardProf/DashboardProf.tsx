    ...
    <div className="container contenue">
      <div className="row">
        <Link to="presenceEtudiant" className="col">
          <div
            className={`d-flex justify-content-center align-items-center gap-2 rounded-top ${
              localStorage.getItem("night") ? "nav-moon" : "nav"
            } `}
          >
            <svg
              width="40"
          ...
          <div
            className={`d-flex flex-column justify-content-center align-items-center gap-2 rounded-top ${
              localStorage.getItem("night") ? " nav-blanc-moon" : " nav-blanc"
            }`}
          >
            <p
              className={`h4 ${
            ...
            >
              <span className={`text-5xl cursor-pointer ${localStorage.getItem("night") ? "text-color-moon": "text-color"}`}> 16 </span>
            </div>
          </div>
        </Link>
        <Link to="presenceEtudiant" className="col">
