...
const Pagination = () => {
  ...
  return (
    <div className="flex mt-3 justify-end items-center gap-2">
        ...
        <button className=" text-white w-12 h-12 px-3 py-2 rounded-full" style={{backgroundColor:'#306887'}}>1</button>
        <button className=" text-gray-700 w-12 h-12 px-3 py-2 rounded-full border">2</button>
...
return (
  <div className="flex mt-3 justify-end items-center gap-2">
      ...
      <button className=" text-white px-3 py-2 rounded-full" style={{backgroundColor:'#306887'}}>{currentPage}</button>
      {currentPage < lastPage &&
          <button className={` text-gray-700  px-3 py-2 rounded-full border ${hoverStyle}`}
                  onClick={() => paginate(currentPage + 1)}>{currentPage + 1}</button>
      }
      {currentPage < lastPage - 1 && <button
          onClick={() => paginate(currentPage + 2)}
          className=" text-gray-700  px-3 py-2 border rounded-full flex items-center justify-center text-center">
